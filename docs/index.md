...
flowchart TB
    ...
    subgraph U1["U1: secuenciales y condicionales"]
        U1A["Entrada-proceso-salida"]
        U1B["Variables y operadores"]
        U1C["Decisiones"]
    end

    subgraph U2["U2: repeticion y procesamiento de datos"]
        U2A["For y while"]
        U2B["Listas y cadenas"]
        U2C["Busqueda, matrices y diccionarios"]
    end

    subgraph U3["U3: soluciones estructuradas y persistencia"]
        U3A["Funciones"]
        U3B["Menus e integracion"]
        U3C["Archivos"]
    end
